...
class UniverseConfig(BaseModel):
    ...
    enabled: bool = False
    node_id: str = ""  # stable identifier for this zerobot node
    ...
    public_capability_vocab: list[str] = Field(
        default_factory=lambda: ["web_search", "web_fetch", "exec", "zerobot.agent", "llm.chat"]
    )
    ...
    public_knowledge_publish_dir: str = "~/.zerobot/knowledge_packs"
    public_knowledge_publish_interval_s: int = 300

    # Public service behavior
    public_allow_agent_tasks: bool = False  # allow kind="zerobot.agent"
