...
from nanobot.universe.relay_client import RelayNodeClient, RelayNodeClientConfig
from nanobot.universe.protocol import Envelope, make_envelope
from nanobot.universe.public_client import knowledge_publish
...
def build_capability_card(cfg: Config, endpoint_url: str) -> dict[str, Any]:
    ...
    if not card.get("summary"):
        card["summary"] = cfg.universe.node_name or "nanobot node"
